...
Run `spec-kitty agent feature -Json -RequireTasks -IncludeTasks` once from repo root and parse JSON for feature_dir and available_docs. Derive absolute paths:
